...
export const Search = () => {
    ...
    const handleHotelTypeChange = (event: React.ChangeEvent<HTMLInputElement>) => {
      ...
      event.target.checked ? [...prevHotelTypes, hotelType] : prevHotelTypes.filter((hotelType)=> hotelType !== hotelType)
      )
    }
    ...
    const handleFacilityChange = (event: React.ChangeEvent<HTMLInputElement>) => {
      ...
      event.target.checked ? [...prevFacilities, facility] : prevFacilities.filter((prevFacilities)=> prevFacilities !== facility)
      )
    }
